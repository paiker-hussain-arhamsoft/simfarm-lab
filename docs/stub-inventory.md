...
| Nmap / OpenVAS / OWASP ZAP / Burp Suite / Metasploit / CAI (Alias Robotics) | **Partial** | Mixed | `nmap_scan` is wired to the system `nmap` binary for authorized targets with stub fallback; OpenVAS/ZAP/Burp/Metasploit/CAI remain simulated. |
